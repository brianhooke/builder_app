...
committedQuotes.forEach(function(quote) {
    console.log("committed_allocations: ", committed_allocations);
    console.log("quote.quote: ", quote.quote);    // console.log(quote.pdf);
    // Format total_cost with thousands separator
    var quote_id = quote.quote;
    ...
    // Get the quote data
    var quote = committedQuotes.find(q => q.quote == this.textContent);
    var allocations = committed_allocations.filter(a => a.fields.quote === quote.quote);
